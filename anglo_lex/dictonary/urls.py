...
urlpatterns = [
    ...
    path('wordbook/<str:wordbook_title>/<str:pk>', ShowDictionary.as_view(), name='show_dict'),
    path('delete/<str:wordbook_title>/<str:pk>', DeleteDictionary.as_view(), name='delete_dict'),
    path('update/<str:wordbook_title>/<str:pk>', UpdateDictionary.as_view(), name='update_dict'),
